...
param appServicePlanName string = 'dev-ptt-chatgpt-appsvplan'
...
var resourceToken = toLower(uniqueString(subscription().id, 'RG-DEV-AZURE-OPENAI-APP', location))
var tags = { 'azd-env-name': 'RG-DEV-AZURE-OPENAI-APP' }
...
module appServicePlan 'core/host/appserviceplan.bicep' = {
  ...
  scope: resourceGroup
  params: {
    name: 'dev-ptt-chatgpt-appsvplan'
    location: location
    tags: tags
    sku: {
      name: 'B1'
