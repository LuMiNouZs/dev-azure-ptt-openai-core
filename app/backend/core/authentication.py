...
class AuthenticationHelper:
    ...
    def get_auth_setup_for_client(self) -> dict[str, Any]:
        ...
        return {
            "useLogin": True,  # Whether or not login elements are enabled on the UI
            "msalConfig": {
                "auth": {
                    "clientId": "6aa1a4cd-d808-48f9-ad01-9882e03e2ce4",  # Client app id used for login
                    "authority": "https://login.microsoftonline.com/common",  # Directory to use for login https://learn.microsoft.com/azure/active-directory/develop/msal-client-application-configuration#authority
